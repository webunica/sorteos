...
const FinalCTA: React.FC<FinalCTAProps> = ({ onVerPaquetesClick }) => {
    return (
        <div className="final-cta">
            <img src="https://templatekit.selaraswp.com/rental/wp-content/uploads/sites/44/2025/10/BMW-XM-SUV-Mockup-01-2.png" alt="" className="car-bg car-left" />
            <img src="https://templatekit.selaraswp.com/rental/wp-content/uploads/sites/44/2025/10/BMW-XM-SUV-Mockup-01-2.png" alt="" className="car-bg car-right" />
